...
def brainStem(tissueLabelFilename,
    ...
    def cropAndResampleInPlace(inputBrainLabelFilename,
        ...
        brainLbl = sitk.ReadImage(str(inputBrainLabelFilename))
        ...
        sitk.WriteImage(brainStemInPlace, str(outputImageFilename))
    ...
    brainLbl = sitk.ReadImage(str(tissueLabelFilename))
    ...
    brainStemBinary = (sitk.ReadImage(str(brainStem)) > 0)
    noExtraBottomBrainStemBinary = (sitk.ReadImage(str(noExtraBottomBrainStem)) > 0)
    ...
    sitk.WriteImage(cleanedOutputTissueLabel, str(full_output_path))
